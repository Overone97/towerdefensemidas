...
const MapSelect: React.FC<MapSelectProps> = ({ stars, mapsCompleted, onSelectMap, onBack }) => {
  return (
          ...
          {ALL_MAPS.map(map => {
            ...
            return (
              ...
              >
                ...
                {completed && <span className="text-green-400 text-xs font-bold">✓ Completed</span>}
                {!unlocked && (
