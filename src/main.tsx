...
function renderBootError(message: string) {
  ...
  root.innerHTML = `
    <div style="min-height:100vh;background:#070d16;color:#fff;display:flex;align-items:center;justify-content:center;padding:24px;font-family:system-ui,Segoe UI,Arial">
      <div style="max-width:820px;width:100%;border:1px solid rgba(248,113,113,.45);background:rgba(127,29,29,.18);padding:18px;border-radius:12px">
        ...
        <p style="opacity:.8;font-size:12px;margin-top:10px">Astuce: hard refresh (Ctrl+F5) ou navigation privée.</p>
      </div>
    </div>
  `;
}
